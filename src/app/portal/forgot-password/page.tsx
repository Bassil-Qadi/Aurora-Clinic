...
import { Mail, ArrowLeft, KeyRound, Heart } from "lucide-react";
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setError(data.error || t("auth.failedToSendRequest"));
      }
    } catch {
      setError(t("auth.failedToSendRequest"));
    } finally {
      setLoading(false);
    }
  }
      ...
      <div className="card w-full max-w-md space-y-5">
        <div className="space-y-2">
          ...
          <h2 className="page-title text-2xl">
            ...
            <span>{t("portal.forgotPassword")}</span>
          </h2>
        ...
        {sent ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              {loading ? t("auth.sending") : t("portal.requestResetLink")}
            </button>
